  ...
  private products = signal<Product[]>([
    {
      ...
      price: 295,
      image: 'https://images.unsplash.com/photo-1539571696357-5a69c17a67c6?q=80&w=735&auto=format&fit=crop',
      images: [
      ...
      description: "Manteau élégant en cachemire pur, parfait pour les journées d'hiver. Confectionné avec le plus grand soin, il offre un confort thermique incomparable et une silhouette structurée intemporelle.",
      category: 'Manteaux',
      stock: 5,
      sizes: ['S', 'M', 'L', 'XL'],
    ...
    },
    {
      ...
      description: 'Chemise légère en lin naturel, idéale pour l\'été. Sa coupe décontractée et sa matière hautement respirante en font un choix privilégié pour vos journées ensoleillées.',
      category: 'Chemises',
      stock: 12,
      sizes: ['XS', 'S', 'M', 'L'],
    ...
    },
    {
      ...
      description: 'Veste structurée aux lignes modernes et polyvalente. Parfaite pour rehausser une tenue décontractée ou pour un rendez-vous professionnel.',
      category: 'Vestes',
      stock: 8,
      sizes: ['S', 'M', 'L'],
      colors: ['#000000', '#4A4A4A', '#8B0000']
    },
    {
      id: 4,
      name: 'Pantalon Taille Haute',
      price: 95,
      image: 'https://images.unsplash.com/photo-1541099649105-f69ad21f3246?q=80&w=687&auto=format&fit=crop',
      images: [
      ...
      description: 'Pantalon taille haute coupe droite, très confortable. Confectionné dans un tissu fluide et résistant qui flatte la silhouette tout en offrant une grande liberté de mouvement.',
      category: 'Pantalons',
      stock: 15,
      sizes: ['XS', 'S', 'M', 'L', 'XL'],
    ...
    },
    {
      ...
      name: 'Robe en Soie',
      price: 180,
      image: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?q=80&w=764&auto=format&fit=crop',
      images: [
      ...
      description: 'Robe fluide en soie avec motif subtil. Sa fluidité apporte une touche de poésie et d\'élégance naturelle à chacun de vos pas.',
      category: 'Robes',
      stock: 4,
      sizes: ['S', 'M', 'L'],
    ...
    },
    {
      ...
      price: 240,
      image: 'https://images.unsplash.com/photo-1548624149-f7b3156c2199?q=80&w=687&auto=format&fit=crop',
      images: [
      ...
      description: 'Blazer classique coupe slim, parfait pour le bureau. Un essentiel de la garde-robe moderne qui structure instantanément n\'importe quel look.',
      category: 'Vestes',
    ...
    },
    {
      ...
      name: 'Trench Coat',
      price: 320,
      image: 'https://images.unsplash.com/photo-1525450824786-227cbef70703?q=80&w=735&auto=format&fit=crop',
      images: [
      ...
      description: 'Trench coat intemporel en coton imperméable. Son design croisé classique avec ceinture amovible s\'adapte à toutes les saisons.',
      category: 'Manteaux',
      stock: 7,
      sizes: ['S', 'M', 'L', 'XL'],
    ...
    },
    {
      ...
      name: 'Ceinture Cuir',
      price: 65,
      image: 'https://images.unsplash.com/photo-1624222247344-550fb8ec5519?q=80&w=700&auto=format&fit=crop',
      images: [
      ...
      description: 'Ceinture en cuir véritable avec boucle métallique dorée minimaliste. L\'accessoire idéal pour souligner la taille de vos robes et manteaux.',
